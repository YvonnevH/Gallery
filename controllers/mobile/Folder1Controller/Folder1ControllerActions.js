define({
    ...
    */
    ...
    AS_Camera_fa02dae0960e4756a7d5cdb4b7d948e6: function AS_Camera_fa02dae0960e4756a7d5cdb4b7d948e6(eventobject, x, y) {
        var self = this;
        kony.application.getCurrentForm().Menu.isVisible = false;
    },
    AS_Form_adbe83eb17a8492eb7f545387640b0d8: function AS_Form_adbe83eb17a8492eb7f545387640b0d8(eventobject) {
        var self = this;
        kony.application.getCurrentForm().Menu.isVisible = false;
    }
});