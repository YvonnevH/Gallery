define({
    ...
    */
    AS_Map_cf6f12bc537d4693a6ce5ad6258052ff: function AS_Map_cf6f12bc537d4693a6ce5ad6258052ff(eventobject, location) {
        var self = this;
        //pinClicked(this.view.Map0.locationData);
        pinClicked.call(this, location);
    },
    ...
    AS_Form_jba8f8dc7b4e41b092216f99d881ced2: function AS_Form_jba8f8dc7b4e41b092216f99d881ced2(eventobject) {
        var self = this;
        kony.application.getCurrentForm().Menu.isVisible = false;
    }
});